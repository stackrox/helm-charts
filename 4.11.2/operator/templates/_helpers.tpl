...
*/}}
{{- define "stackrox-operator.fullname" -}}
...
*/}}
{{- define "stackrox-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "stackrox-operator.resourceName" -}}
{{- $fullname := include "stackrox-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "stackrox-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "stackrox-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
